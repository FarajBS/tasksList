...
function fillTasksOnThePage()
{
    ...
    for(task of tasks)
    {
        ...
        `
            <!-- BEGIN: LIST -->
            <div id="list" class="row mt-3 p-3 rounded-pill">
                    ...
                    <div class="row">
                        ...
                        ` 
                            <div class="col-sm-4" style="padding: 0;">
                                <div onclick="toggleTaskcompletion(${index})" class="center-list d-flex justify-content-center align-items-center" style="background-color: green;">
                        ...
                        `}
                        <div class="col-sm-4" style="padding: 0;">
                            <div onclick="editTask(${index})" class="center-list d-flex justify-content-center align-items-center" style="background-color: blue;">
                                <span class="material-symbols-outlined">
                                    edit
                                </span>
                            </div>
                        ...
                        <div class="col-sm-4" style="padding: 0;">
                            <div onclick="deleteTask(${index})" class="center-list d-flex justify-content-center align-items-center" style="background-color: red;">
                                <span class="material-symbols-outlined">
                                    delete
                                </span>
                            </div>
